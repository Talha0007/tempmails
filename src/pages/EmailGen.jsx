      ...
      >
        ...
        <Box>
          <Typography variant="h6" sx={{ margin: 1 }}>
            The Random Gmail Generator is a user-friendly web tool designed for
            the creation of random Gmail addresses. It offers a convenient
          ...
          <Typography variant="h6" sx={{ margin: 1 }}>
            ...
            address without the need to devise a unique username manually. Users
            can easily copy the generated email from the text input field with a
            single click, facilitating its use in various registration or
            sign-up processes.
          </Typography>
          <Typography variant="h6" sx={{ margin: 1 }}>
          ...
          <Typography variant="h6" sx={{ margin: 1 }}>
            It's crucial to note that the generated email addresses are randomly
            created and hold no connection to actual Gmail accounts. They are
            intended for temporary or one-time use, providing no access to an
            existing mailbox.
          </Typography>
        </Box>
      </Container>
